...
seed=7
nTrials=2000          # more exploration for high score_power
nFiles=300
fillOpt="next_open"
...
# Regime filter defaults (can be tuned)
...
run_phase() {
    ...
    echo "ret_floor/k    = $ret_floor_center / $ret_floor_k"
...
# E - Hybrid aggressive quality + min_trades safety
...
echo "Check output/*.csv and logs for best_score, coverage, stability_score, negatives count, median PF, etc."
